...
function sumAndMultiply(a, b, c) {
  ...
  let t =multiply(m,c)[0];
  
  //eslint-disable-line
  return [z,t,`${a} and ${b} and ${c} sum to ${z}.`,`The product of ${a} and ${b} and ${c} is ${t}.`];
}
...
function multiplyAnyArray(dynamicArray) {
  ...
  // let x=multiply( testDynamicArray[0],testDynamicArray[1])[0];
  // let y=multiply(testDynamicArray[2],testDynamicArray[3])[0];
  // let r=multiply(x,y)[0];
  // let m=multiply(r,testDynamicArray[4])[0];
  // // console.log(m);
  // //eslint-disable-line
